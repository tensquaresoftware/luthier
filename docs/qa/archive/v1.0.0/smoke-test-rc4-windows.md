...
**Audience:** supplement to the [full smoke test](./smoke-test-three-os.md) — completes **Phase B** (build/regen) and **Phase D2** not validated under rc2  
...
**Verdict:** all three criteria are ✅ — the full smoke test can mark **G-02**, **G-04**, and **G-05** as ✅ (see [full smoke test](./smoke-test-three-os.md)).

---

## References

- [Full 3-OS smoke test](./smoke-test-three-os.md)
