...
| **Commit / tag tested** | Smoke: `1.0.0-rc2` / `1.0.0-rc4` · **Published release: `1.0.0`** (10/07/2026) |
| **Smoke test end date** | 10/07/2026 |
...
| **Dev machine** | MacBook Pro M5 (2025) / macOS Tahoe 26.5.1 |
| **Shared prefs file** | `/Users/Guillaume/Library/CloudStorage/Dropbox/Dev/Tests/Luthier/luthier-smoke-prefs.json` |

### Phase progress

| Phase | Description | ~ Duration | ✅ Done | Date | Open blockers |
| --- | --- | --- | :---: | --- | --- |
| **P** | Preferences (3 OS + shared file) | 60 min | ✅ | 09–10/07/2026 | — |
| **A** | Project — macOS smoke (Apple Silicon) | 45 min | ✅ | 09/07/2026 | — |
| **B** | Project — Windows smoke | 45 min | ✅ | 10/07/2026 | Validated via [rc4 Windows](./smoke-test-rc4-windows.md) |
| **C** | Project — Linux smoke | 45 min | ✅ | 10/07/2026 | — |
| **D** | Cross-OS Git (generated project) | 45 min | ✅ | 10/07/2026 | D2 validated rc4 |
...
**Build tested:** 1.0.0-rc2 | **Date:** 09/07/2026  
...
**Build tested:** generation `1.0.0-rc2` · build/regen **`1.0.0-rc4`** ([detail](./smoke-test-rc4-windows.md)) | **Date:** 10/07/2026  
...
- Windows modal button order (B-503)
- Linux window position not guaranteed (C-003)
- Linux icon without `.desktop` (P-C-004)
- Compiler warnings in third-party JUCE headers only
- CMake Tools false positives « Task has errors » after post-build copy (generated project README)
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | B-701 | Windows | CMake presets target VS 2022 | Configure with VS 2026 installed | Configure failure (generator not found) | ~~blocking~~ | **Resolved rc3** — VS 2026 preset; validated rc4 W3 |
| 2 | B-405, B-406 | Windows | In-session regeneration with `.git/` | Regen OK, `.git/` preserved | `WinError 32` (rc2/rc3) | ~~annoying~~ | **Resolved rc4** — rename aside; validated W2 |
| 3 | D-302 | Linux | Linux JUCE path on Git clone | Clear `.luthier.json` edit | Tester question | minor (doc) | D-302 box; test OK |
